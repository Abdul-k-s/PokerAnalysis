...
{
    public class RiverReceivedCommand : CommandBase

    {
        private readonly TodoItemListingViewModel _todoItemListingViewModel;


        public RiverReceivedCommand(TodoItemListingViewModel todoItemListingView)
        {
        ...
        {
            return _todoItemListingViewModel.Getlength() < 4 && base.CanExecute(parameter);
        }
